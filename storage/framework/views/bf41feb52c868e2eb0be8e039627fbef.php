...
<div class="layout">
    ...
    <div class="sidebar">
        ...
        <div class="menu">
            ...
            <a href="<?php echo e(route('admin.katalog')); ?>"
               class="<?php echo e(request()->routeIs('admin.katalog*') ? 'active' : ''); ?>">
                Katalog
            </a>

            <a href="<?php echo e(route('admin.pinjaman')); ?>"
               class="<?php echo e(request()->routeIs('admin.pinjaman*') ? 'active' : ''); ?>">
                Status Peminjaman
            </a>

            <a href="<?php echo e(route('admin.data-admin')); ?>"
               class="<?php echo e(request()->routeIs('admin.data-admin*') ? 'active' : ''); ?>">
                Data Admin
            </a>
        ...
        <div class="topbar">
            ...
            <div class="user-menu">
                ...
                <span onclick="toggleMenu()" style="cursor:pointer">
                    Welcome, <?php echo e(session('admin_name', $adminName ?? 'admin')); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/KOPERASIINTERNAL/resources/views/layouts/admin.blade.php ENDPATH**/ ?>