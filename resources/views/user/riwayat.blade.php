  ...
  <body>  
    <nav class="navbar">
      ...
      <ul class="nav-links">
        ...
        <li><a href="{{ route('user.riwayat') }}" class="nav-item active">Riwayat Belanja</a></li>
              ...
              <div class="order-card">
                <div class="card-top">
                  <div class="order-id">
                    ...
                    <span>Pesanan {{ $order->kode }}</span>
                  </div>
                  <span class="order-date">{{ $orderDateTime }}</span>
                </div>
                ...
                <div class="card-body">
                  <div class="product-summary">
                    <img src="{{ $thumbImage }}" alt="Produk Thumbnail" class="thumb-img">
                    <div class="summary-text">
                      <h4>{{ $summaryTitle }}</h4>
                      <p>{{ $summaryLine }}</p>
                    </div>
                  ...
                  <div class="price-section">
                    <h3>Rp. {{ number_format($order->total ?? 0, 0, ',', '.') }}</h3>
                  </div>
                </div>

                <div class="card-footer">
                  <a href="{{ route('user.riwayat.detail', $order->id) }}" class="link-detail">Lihat Detail ></a>
                </div>
              </div>
            @endforeach
          @endif
