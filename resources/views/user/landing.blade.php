...
<html lang="id">
  ...
  <body>
    <nav class="navbar">
      ...
      <ul class="nav-links">
        <li><a href="{{ route('user.landing') }}" class="nav-item active">Beranda</a></li>
      ...
      <div class="auth-button">
        ...
        {{-- KONDISI 3: JIKA SUDAH LOGIN (AUTH) --}}
        @auth
        <div class="user-logged-in" style="display: flex; align-items: center; gap: 15px;">
            
            {{-- TOMBOL KERANJANG (Sama dengan halaman belanja) --}}
      ...
      <div class="container">
        <div class="main-banner">
          <div class="banner-logo">
            <img src="{{ asset('user/assets/logo.png') }}" alt="Logo Koperasi" />
          </div>
          <div class="banner-content">
            ...
            <a href="{{ route('user.belanja') }}" class="btn-cta">Lihat Katalog Sekarang</a>
          </div>
        </div>
        ...
        <div class="features-grid">
          <div class="feature-card">
            <div class="icon-circle pink-bg">
              <img src="{{ asset('user/assets/icon1.png') }}" alt="Belanja ATK" />
            </div>
          ...
          <div class="feature-card">
            <div class="icon-circle grey-bg">
              <img src="{{ asset('user/assets/icon2.png') }}" alt="Tanpa Tunai" />
            </div>
          ...
          <div class="feature-card">
            <div class="icon-circle grey-bg">
              <img src="{{ asset('user/assets/icon3.png') }}" alt="Riwayat Belanja" />
            </div>
      ...
      <div class="container">
        <div class="about-card">
          ...
          <div class="about-image-wrapper">
            <img src="{{ asset('user/assets/office_btn.png') }}" alt="Kantor BTN" class="about-img">
    ...
    <section class="product-section">
      <div class="container">
          ...
          @if(isset($products) && count($products) > 0)
            @foreach($products as $product)
              ...
              <div class="product-card">
                <span class="badge-category">{{ $productCategory }}</span>
        ...
        <div class="more-button-wrapper">
          <a href="{{ route('user.belanja') }}" class="btn-see-more">Lihat Selengkapnya!</a>
        </div>
    ...
    <div id="loginModal" class="modal-overlay {{ $errors->login->any() ? 'show-modal' : '' }}">
        <div class="modal-content">
            ...
            <form class="login-form" method="POST" action="{{ route('login.proses') }}">
                ...
                {{-- PESAN ERROR HANYA MUNCUL DI SINI (DALAM MODAL) --}}
                @if ($errors->login->any())
                ...
                <div class="input-group">
                    ...
                    <input type="text" id="nip" name="nip" value="{{ old('nip') }}" placeholder="Contoh: 19902022..." required>
