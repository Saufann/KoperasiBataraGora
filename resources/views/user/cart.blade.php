...
<head>
    ...
    {{-- Import Font yang sama dengan halaman belanja --}}
...
<div class="container">
    <div class="card">
        ...
        <a href="{{ route('user.belanja') }}" class="btn-back">
                ...
                <tbody>
                    ...
                    @foreach($cart as $id => $item)
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('user.cart.update', $id) }}" method="POST" class="qty-form">
                                    @csrf
                            ...
                            <td>
                                <a href="{{ route('user.cart.remove', $id) }}" class="btn-remove">Hapus</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
